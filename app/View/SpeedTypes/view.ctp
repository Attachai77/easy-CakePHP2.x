    ...
    <div class="col-xs-12">
		...
		<div class="box box-primary">
			<div class="box-header">
				<h3 class="box-title"><?php  echo __('Speed Type'); ?></h3>
				<div class="box-tools pull-right">
	                <?php echo $this->Html->link(__('<i class="glyphicon glyphicon-pencil"></i> Edit'), array('action' => 'edit', $speedType['SpeedType']['id']), array('class' => 'btn btn-primary', 'escape' => false)); ?>
	            </div>
			</div>
		...
		<td>
			<?php echo h($speedType['SpeedType']['id']); ?>
			&nbsp;
		</td>
</tr><tr>		<td><strong><?php echo __('Name'); ?></strong></td>
		<td>
			<?php echo h($speedType['SpeedType']['name']); ?>
			&nbsp;
		</td>
</tr><tr>		<td><strong><?php echo __('Deleted'); ?></strong></td>
		<td>
			<?php echo h($speedType['SpeedType']['deleted']); ?>
			&nbsp;
		</td>
</tr><tr>		<td><strong><?php echo __('Created'); ?></strong></td>
		<td>
			<?php echo h($speedType['SpeedType']['created']); ?>
			&nbsp;
		</td>
</tr><tr>		<td><strong><?php echo __('Create Uid'); ?></strong></td>
		<td>
			<?php echo h($speedType['SpeedType']['create_uid']); ?>
			&nbsp;
		</td>
</tr><tr>		<td><strong><?php echo __('Modified'); ?></strong></td>
		<td>
			<?php echo h($speedType['SpeedType']['modified']); ?>
			&nbsp;
		</td>
</tr><tr>		<td><strong><?php echo __('Update Uid'); ?></strong></td>
		<td>
			<?php echo h($speedType['SpeedType']['update_uid']); ?>
			&nbsp;
		</td>
</tr>					</tbody>
			...
			<div class="box box-primary">
				...
				<?php if (!empty($speedType['Document'])): ?>
		...
		<th class="text-center"><?php echo __('Document Ref Id'); ?></th>
							...
							<tbody>
									<?php
										$i = 0;
										foreach ($speedType['Document'] as $document): ?>
		<tr>
