...
<div class="row">
    <div class="col-xs-6 col-xs-offset-3">
		<div class="box box-primary">
			...
			<h3 class="box-title"><?php echo __('Edit Speed Type'); ?></h3>
			</div>
			<div class="box-body table-responsive">
		
			<?php echo $this->Form->create('SpeedType', array('role' => 'form')); ?>
				...
				<fieldset>
					...
					<?php echo $this->Html->link('Back','/Speed Types', array('class' => 'btn btn-large btn-warning pull-right','style'=>'margin-right:10px;')); ?>
