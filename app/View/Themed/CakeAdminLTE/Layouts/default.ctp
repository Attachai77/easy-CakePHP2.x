...
<html>
	<head>
		...
		<?php 
			...
			echo $this->Html->css('modal-animate/style');
	...
	<body class="skin-blue fixed">
		...
		<div class="wrapper row-offcanvas row-offcanvas-left">
		    ...
		    <aside class="right-side">  
		    	<section class="content-header">
				    <h1>
				        <?php echo $title_for_layout; ?>
						<?php $sub_title_for_layout = (!isset($sub_title_for_layout)) ? '' : $sub_title_for_layout ;; ?>
				        <small><?php echo $sub_title_for_layout; ?></small>
				    </h1>
				    <ol class="breadcrumb">
		...
		<?php
			...
			echo $this->Html->script('modal-animate/index');
