    ...
    <div class="col-xs-12">
		...
		<div class="box box-primary">
			<div class="box-header">
				<h3 class="box-title"><?php  echo __('Document Title'); ?></h3>
				<div class="box-tools pull-right">
	                <?php echo $this->Html->link(__('<i class="glyphicon glyphicon-pencil"></i> Edit'), array('action' => 'edit', $documentTitle['DocumentTitle']['id']), array('class' => 'btn btn-primary', 'escape' => false)); ?>
	            </div>
			</div>
		...
		<td>
			<?php echo h($documentTitle['DocumentTitle']['id']); ?>
			&nbsp;
		</td>
</tr><tr>		<td><strong><?php echo __('Name'); ?></strong></td>
		<td>
			<?php echo h($documentTitle['DocumentTitle']['name']); ?>
			&nbsp;
		</td>
</tr><tr>		<td><strong><?php echo __('Deleted'); ?></strong></td>
		<td>
			<?php echo h($documentTitle['DocumentTitle']['deleted']); ?>
			&nbsp;
		</td>
</tr><tr>		<td><strong><?php echo __('Created'); ?></strong></td>
		<td>
			<?php echo h($documentTitle['DocumentTitle']['created']); ?>
			&nbsp;
		</td>
</tr><tr>		<td><strong><?php echo __('Create Uid'); ?></strong></td>
		<td>
			<?php echo h($documentTitle['DocumentTitle']['create_uid']); ?>
			&nbsp;
		</td>
</tr><tr>		<td><strong><?php echo __('Modified'); ?></strong></td>
		<td>
			<?php echo h($documentTitle['DocumentTitle']['modified']); ?>
			&nbsp;
		</td>
</tr><tr>		<td><strong><?php echo __('Update Uid'); ?></strong></td>
		<td>
			<?php echo h($documentTitle['DocumentTitle']['update_uid']); ?>
			&nbsp;
		</td>
</tr>					</tbody>
			...
			<div class="box box-primary">
				...
				<?php if (!empty($documentTitle['Document'])): ?>
		...
		<th class="text-center"><?php echo __('Document Ref Id'); ?></th>
							...
							<tbody>
									<?php
										$i = 0;
										foreach ($documentTitle['Document'] as $document): ?>
		<tr>
