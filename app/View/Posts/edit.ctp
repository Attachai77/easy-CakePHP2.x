...
<div class="row">
    <div class="col-xs-6 col-xs-offset-3">
		<div class="box box-primary">
			...
			<h3 class="box-title"><?php echo __('Edit Post'); ?></h3>
			</div>
			...
			<?php echo $this->Form->create('Post', array('role' => 'form')); ?>
				...
				<fieldset>
					...
					<?php echo $this->Html->link('Back','/Posts', array('class' => 'btn btn-large btn-warning pull-right','style'=>'margin-right:10px;')); ?>
