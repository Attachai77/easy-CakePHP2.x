			...
			<?php echo "<?php echo \$this->Form->create('{$modelClass}', array('role' => 'form')); ?>\n"; ?>
				...
				<fieldset>
					...
					<?php
						...
						echo "\t\t\t\t\t<?php echo \$this->Form->submit('Submit', array('class' => 'btn btn-large btn-primary pull-right')); ?>\n";
						echo "\t\t\t\t\t<?php echo \$this->Html->link('Back','/{$pluralHumanName}', array('class' => 'btn btn-large btn-warning pull-right','style'=>'margin-right:10px;')); ?>\n";
					?>
